...
namespace Evbpc.Framework.Tests.Utilities.Extensions
{
    ...
    public class DateTimeExtensionsTests
    {
        ...
        {
            var expected = new DateTime(1970, 1, 1, 0, 0, 1, 0, DateTimeKind.Utc);
            var input = 1;
        ...
        {
            var expected = 1;
            var input = new DateTime(1970, 1, 1, 0, 0, 1, 0, DateTimeKind.Utc);
        ...
        {
            var expected = new DateTime(1970, 1, 1, 0, 1, 1, 0, DateTimeKind.Utc);
            var input = 61;
        ...
        {
            var expected = 61;
            var input = new DateTime(1970, 1, 1, 0, 1, 1, 0, DateTimeKind.Utc);
        ...
        {
            var expected = new DateTime(1970, 1, 1, 1, 0, 1, 0, DateTimeKind.Utc);
            var input = 3601;
        ...
        {
            var expected = 3601;
            var input = new DateTime(1970, 1, 1, 1, 0, 1, 0, DateTimeKind.Utc);
        ...
        {
            var expected = new DateTime(1970, 1, 2, 0, 0, 1, 0, DateTimeKind.Utc);
            var input = 86401;
        ...
        {
            var expected = 86401;
            var input = new DateTime(1970, 1, 2, 0, 0, 1, 0, DateTimeKind.Utc);
        ...
        {
            var expected = new DateTime(1970, 2, 1, 0, 0, 1, 0, DateTimeKind.Utc);
            var input = 2678401;
        ...
        public void DateTimeToEpoch_1970_2_1_0_0_1_0()
        {
            ...
            var input = new DateTime(1970, 2, 1, 0, 0, 1, 0, DateTimeKind.Utc);
        ...
        {
            var expected = new DateTime(1971, 1, 1, 0, 0, 1, 0, DateTimeKind.Utc);
            var input = 31536001;
        ...
        public void DateTimeToEpoch_1971_1_1_0_0_1_0()
        {
            ...
            var input = new DateTime(1971, 1, 1, 0, 0, 1, 0, DateTimeKind.Utc);
        ...
        {
            var expected = new DateTime(1980, 1, 1, 0, 0, 1, 0, DateTimeKind.Utc);
            var input = 315532801;
        ...
        public void DateTimeToEpoch_1980_1_1_0_0_1_0()
        {
            ...
            var input = new DateTime(1980, 1, 1, 0, 0, 1, 0, DateTimeKind.Utc);
        ...
        {
            var expected = new DateTime(2015, 1, 1, 0, 0, 1, 0, DateTimeKind.Utc);
        ...
        public void DateTimeToEpoch_2015_1_1_0_0_1_0()
        {
            ...
            var input = new DateTime(2015, 1, 1, 0, 0, 1, 0, DateTimeKind.Utc);
