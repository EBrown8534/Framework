...
{
    /// <summary>
    /// Represents a type of message or an <see cref="ILogger.Severity"/>.
    /// </summary>
    public enum Severity : byte
    {
        /// <summary>
        /// Should be logged regardless of <see cref="ILogger.Severity"/>.
        /// </summary>
        ...
        /// <summary>
        /// This should never be directly used by a message, but only be <see cref="ILogger.Severity"/>. Indicates that all messages will be logged.
        /// </summary>
