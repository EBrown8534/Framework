...
{
    /// <summary>
    /// Allows conversion of a <see cref="RectangleF"/> to various types.
    /// </summary>
    public class RectangleFConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (valueString != null)
            {
                ...
                return new RectangleF(float.Parse(v[0]), float.Parse(v[1]), float.Parse(v[2]), float.Parse(v[3]));
            }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                RectangleF? valueRectangle = value as RectangleF?;

                if (valueRectangle != null)
                {
                    return valueRectangle.Value.X + "," + valueRectangle.Value.Y + "," + valueRectangle.Value.Width + "," + valueRectangle.Value.Height;
                }
            }
